...
✔ fib.stoa
❌ functions.stoa
diff <(functions.stoa) functions.stoa.txt
1,2c1
< ./functions.stoa: line 4: syntax error near unexpected token `('
< ./functions.stoa: line 4: `fun makeCounter(start) {'
---
> 213
✔ hello-world.stoa
✔ literals.stoa
