import { TokenStreamClassFactory, Token, TokenStream, Parser, Visitable } from './lib'
...
export const LoxScanner = TokenStreamClassFactory.build({
...
export const Lx = LoxScanner.TOKENS

export class LoxParser extends Parser<typeof LoxScanner.TOKENS, Expression> {
    constructor(stream: TokenStream<typeof LoxScanner.TOKENS>) {
        super(stream)
    }
...
type Expression = Visitable<LoxVisitor>
...
export interface LoxVisitor<T = void> {
